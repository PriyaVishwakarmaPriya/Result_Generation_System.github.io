...
ayu1:
printf("\nEnter The Computer  System Security ");
 scanf("%d",&n);
 if(n>80){
 printf("\nplz enter less than 80 ");
 goto ayu1;
...
ayus1:
printf("\nEnter The Computer  System Security(prac) ");
 scanf("%d",&n1);
 if(n1>20){
 printf("\nplz enter less than 20 ");
 goto ayus1;
...
ayu2:
printf("\nEnter Discrete Structures &  Theory  Of Logic ");
 scanf("%d",&o);
if(o>80){
printf("\nplz enter less than 80 ");
 goto ayu2;
 ...
 ayus2:
 printf("\nEnter Discrete Structures &  Theory  Of Logic(prac) ");
 scanf("%d",&o1);
 if(o1>20){
     printf("\nplz enter less than 20 ");
 goto ayus2;
...
ayu4:
printf("\nEnter Database  Management  System  ");
 scanf("%d",&q1);
 if(q1>80){
 printf("\nplz enter less than 80 ");
 goto ayu4;
...
i1++;}
printf("\n|");
printf("\n| \t\t\t THIRD SEMESTER OF BACHELOR OF TECHNOLOGY , 2021-22 ");
printf("\n|\n");
while(i<113){
printf("-");
i++;
...
printf("\n| The Computer  System Security\t\t\t| %d\t\t| --\t\t|\t80 \t|\t%d %c\t|",n,n,x);
printf("\n| The Computer  System Security(prac)\t\t| --\t\t| %d\t\t|\t20 \t|\t%d \t|",n1,n1);
printf("\n| Discrete Structures &  Theory  Of Logic \t| %d\t\t| --\t\t|\t80 \t|\t%d %c\t|",o,o,y);
printf("\n| Discrete Structures &  Theory  Of Logic(prac) | --\t\t| %d\t\t|\t20 \t|\t%d %c\t|",o1,o1);
printf("\n| OOPS & Data Structure\t\t\t\t| %d\t\t| --\t\t|\t80 \t|\t%d %c\t|",p,p,u);
printf("\n| OOPS & Data Structure (prac)\t\t\t| -- \t\t| %d\t\t|\t20 \t|\t%d \t|",p1,p1);
printf("\n| Database  Management  System \t\t\t| %d\t\t| %d\t\t|\t100 \t|\t%d %c\t|\n",q1,q2,q1+q2,v);
while(l<113){
printf("-");
l++;
}
